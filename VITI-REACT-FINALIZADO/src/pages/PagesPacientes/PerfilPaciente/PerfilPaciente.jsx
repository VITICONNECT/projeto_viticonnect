...
function PerfilPaciente() {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      ...
      const response = await axios.put(`http://localhost:8080/pacientes/${userId}`, {
      id: userId,
      ...filteredValues,
    }, {
      headers: {
  ...
  return (
    <Formik initialValues={initialValues} onSubmit={handleFormSubmit}>
      {({ handleChange, values, errors, handleSubmit }) => (
        <div className='backPerfilPaciente'>
    
        <div id='containerPerfilPaciente'>
            
            <div className='servicoPerfilPaciente'>
              ...
              <Form noValidate onSubmit={handleSubmit} className='w-20'>
                ...
                <div className='alert alert-success mt-3 text-center' role='alert'>
                  Dados Atualizados!
                    ...
                    <h1 id='h1ServicoPerfilPaciente'>ATUALIZAR CADASTRO</h1>
                ...
                <Button className='btnAtualizarPaciente' type='submit'>
